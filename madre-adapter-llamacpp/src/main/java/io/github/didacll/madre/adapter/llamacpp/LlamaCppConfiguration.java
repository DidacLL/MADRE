...
/** Explicit installed llama.cpp connector facts. Locality supplies no algebraic defaults. */
public record LlamaCppConfiguration(CapabilityId id, URI endpoint, String modelAlias,
    ...
    public LlamaCppConfiguration {
        ...
        Objects.requireNonNull(privacy); Objects.requireNonNull(integrity); Objects.requireNonNull(expectedLatency);
