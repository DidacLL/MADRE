...
public interface ReasoningMechanismProvider extends AutoCloseable {
    /** Stable provider-owned identity and owner-facing configuration metadata. */
    ReasoningProviderDescriptor descriptor();

    /** Provider-owned editor for named instance configuration and lifecycle state. */
    ReasoningProviderConfigurator configurator();
