...
/** Request to embed one text value into one explicitly identified vector space. */
public record TextEmbeddingCommand(String text, EmbeddingSpace space)
    ...
    @Override public Class<TextEmbeddingResult> resultType() {
        return TextEmbeddingResult.class;
    }
}
