...
publishing {
    publications {
        create<MavenPublication>("mavenJava") {
            ...
            pom {
                name = "MADRE Experimental SDK"
                description = "0.x incubation artifact for higher-level MADRE SDK authoring facilities that have not graduated to the stable SDK."
