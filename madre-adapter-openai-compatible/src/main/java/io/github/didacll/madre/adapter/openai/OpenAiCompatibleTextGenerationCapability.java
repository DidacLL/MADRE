...
/** OpenAI-compatible chat-completions mechanism for the richer text-generation contract. */
public final class OpenAiCompatibleTextGenerationCapability
    ...
    public OpenAiCompatibleTextGenerationCapability(OpenAiCompatibleConfiguration configuration) {
