...
- State: Bootstrap ready for implementation; runtime implementation has not started.
...
START FROM: The latest agentic/madredev-bootstrap branch on origin (fetch it first). Create agentic/durable-work-slice from that state; preserve unrelated changes.
